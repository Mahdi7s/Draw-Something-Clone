 ...
 */
public class LampsButton extends RelativeLayout implements View.OnClickListener
{
	private final UnitOfWork uow;
	private CTextView numView = null;

	public LampsButton (Context context, AttributeSet attrs)
	{
		super(context, attrs);
		...
		imgBg.setImageResource(R.drawable.lamp_numbers);
	...
	public void onEvent (LampsIncrementEvent event)
	{
		numView.setText(event.getLampsCount() + "");
	}
	...
	public void refreshLamps ()
	{
		if (!uow.getLocalRepo().isFirstRun())
		{
			...
			numView.setText(userScore.getLampsCount() + "");
		}
	}
	...
	public void onClick (View v)
	{
		...
		Intent intent = new Intent(getContext(), ItemsStoreActivity.class);
